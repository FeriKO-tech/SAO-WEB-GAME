...
export const metadata: Metadata = {
  title: 'Terms of Service | Sword Art Online',
  description: 'Terms of Service for the Sword Art Online browser MMORPG.',
};
        ...
        <div className="space-y-8">
          {sections.map((s, i) => (
            <section key={i} className="bg-card/30 backdrop-blur-sm border border-border/50 rounded-xl p-6">
              ...
              <div className="text-muted-foreground leading-relaxed" dangerouslySetInnerHTML={{ __html: s.body }} />
              {s.list && (
